...
st.markdown("Cirme locations in San Frnacisco")
st.map(subset_data)
...
labels=subsets_data["Resolution"].unique()
ax1.pie(subser_data[Resolution].value_counts(), labels=labels, autopct="%1.1f%", startangle=20)
st.pylot(fig1)
